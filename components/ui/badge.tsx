...
export default function Badge({ text, color, dot, onClick }: BadgeProps) {
  const badgeClassName = classNames(
    "bg-gray-200 text-gray-600 rounded-full px-2.5 py-2 flex items-center gap-2 text-[12px] leading-[1] font-semibold",
